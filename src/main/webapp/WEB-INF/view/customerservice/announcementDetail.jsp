		...
		<div class="row gx-4 gx-lg-5 justify-content-center">
			<div class="container List-container">
				...
				<div class="board-footer">
					<a href="/customerservice/announcement?page=${page}"
						class="btn btn-primary list-btn">목록</a>
					<c:if test="${user.roleTypeId == 2}">
						<a
							href="/customerservice/announcement/modify?id=${announcement.id}&page=${page}"
							class="btn btn-primary list-btn">수정하기</a>
						<a
							href="/customerservice/announcement/delete?id=${announcement.id}"
